// <<./lib/MacroDeclaration.js>> ( mdlp.md:399)
// <<contains_macro_declaration>> ( mdlp.md:93)
...
// <<parse-macro-declaration-header>> ( mdlp.md:111)
/**
...
function ParseMacroDeclarationHeader(l, lineNumber, filename) {
    ...
    // <<parse-macro-declaration-header-error1>> ( mdlp.md:366)
    if(r == null) {
    ...
    // <<parse-macro-declaration-header-error2>> ( mdlp.md:374)
    if(result.name == "") {
    ...
    // <<parse-macro-declaration-header-error3>> ( mdlp.md:382)
    else {
        r = (/\+?=/).exec(l);
        if(r == null) {
...
// <<macro-content-object>> ( mdlp.md:174)
...
function MacroDeclaration() {
    // <<macro-declaration-object>> ( mdlp.md:71)
    this.Name = "";
    /**
...
MacroDeclaration.prototype = {
    // <<macro-declaration-prototype>> ( mdlp.md:234)
...
function ParseMacroDeclaration(lines, lineNumber, filename) {
    // <<check-contain-macro>> ( mdlp.md:102)
    ...
    // <<extract-macro-content>> ( mdlp.md:143)
