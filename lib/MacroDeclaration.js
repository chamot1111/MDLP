// ./lib/MacroDeclaration.js ( mdlp.md:396)
// contains_macro_declaration ( mdlp.md:90)
...
// parse-macro-declaration-header ( mdlp.md:108)
/**
...
function ParseMacroDeclarationHeader(l, lineNumber, filename) {
    ...
    // parse-macro-declaration-header-error1 ( mdlp.md:363)
    if(r == null) {
    ...
    // parse-macro-declaration-header-error2 ( mdlp.md:371)
    if(result.name == "") {
    ...
    // parse-macro-declaration-header-error3 ( mdlp.md:379)
    else {
        r = (/\+?=/).exec(l);
        if(r == null) {
...
// macro-content-object ( mdlp.md:171)
...
function MacroDeclaration() {
    // macro-declaration-object ( mdlp.md:68)
    this.Name = "";
    /**
...
MacroDeclaration.prototype = {
    // macro-declaration-prototype ( mdlp.md:231)
...
function ParseMacroDeclaration(lines, lineNumber, filename) {
    // check-contain-macro ( mdlp.md:99)
    ...
    // extract-macro-content ( mdlp.md:140)
